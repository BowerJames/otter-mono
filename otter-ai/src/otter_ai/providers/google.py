...
Upstream: packages/ai/src/providers/google.ts (~458 lines)
"""
...
# ============================================================================
# Counter for unique tool call IDs
# ============================================================================
...
def _create_client(
    ...
    if model.base_url:
        ...
        http_options["api_version"] = ""  # base_url already includes version
    merged_headers = {}
    if model.headers:
...
def stream_google(
    ...
    """Stream completions from the Google Generative AI API.

    Upstream: google.ts → streamGoogle()
    """
    from otter_ai.types import (
...
def stream_simple_google(
    ...
    """Simplified Google streaming with automatic thinking configuration.

    Upstream: google.ts → streamSimpleGoogle()
    """
