...
DO NOT EDIT MANUALLY — regenerate via::
    ...
    uv run python otter-ai/scripts/generate_models.py
...
from otter_ai.types import Model, ModelCost, OpenAICompletionsCompat
...
MODELS: dict[str, dict[str, Model]] = {
    ...
    "xai": {
        ...
        "grok-4.20-beta-latest-non-reasoning": Model(
        ...
        "grok-4.20-beta-latest-reasoning": Model(
        ...
        "grok-4.20-multi-agent-beta-latest": Model(
